...
@NamedChatButton('chats_minus')
@MinimalRank(Command.CHATS.minimalRank)
export class ChatsMinusButton extends BaseButtonExecutor {
    ...
    public override async execute(message: ChatButtonEvent): Promise<void> {
        ...
        const willSendMessage : NicksMessage = await ButtonMessages.getChats(newPage)
